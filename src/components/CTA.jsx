  ...
  return (
    <section id="contact" className="relative py-28">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        <div className="rounded-3xl border border-white/10 bg-white/5 backdrop-blur-2xl p-10 overflow-hidden hairline">
          ...
          <div className="relative grid lg:grid-cols-2 gap-10 items-center">
            <div>
              <h3 className="text-2xl sm:text-3xl font-semibold text-lux">Join the private beta</h3>
              <p className="mt-3 text-white/75">We onboard a limited number of partners each quarter to ensure white-glove delivery. Tell us about your vision.</p>
            </div>
